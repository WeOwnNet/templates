...
flowchart TB
    ...
    subgraph Level3["Level 3: Personal"]
        INT005["INT-005: AI.YonksTEAM.xyz<br/>@GTM + @THY #Home"]
        INT008["INT-008: AI.RomanDiD.xyz<br/>@RMN #Home"]
        INT009["INT-009: AI.CoachLFG.com<br/>@LFG #Home"]
    ...
    style INT008 fill:#FFD700,stroke:#333,stroke-width:2px
    style INT009 fill:#FFD700,stroke:#333,stroke-width:2px
...
| **2** | INT-002 | Lite.BurnedOut.xyz | 🔥 BurnedOut.Media 🔀 / #ProjectConnex | SEEK:META |
| **2** | INT-004 | VSA.ccc.bot | 🔍 Verification Services | Verification only (R-203) |
| **3** | INT-005 | AI.YonksTEAM.xyz | 🏠 #HomeInstance (@GTM + @THY) | Personal, SEEK:META |
| **3** | INT-006 | TBD | 🏠 #HomeInstance (@SHD) | ⬜ RESERVED |
| **3** | INT-008 | AI.RomanDiD.xyz | 🏠 #HomeInstance (@RMN) | 🔄 SETUP |
| **3** | INT-009 | AI.CoachLFG.com | 🏠 #HomeInstance (@LFG) | ⬜ @SHD P1 |
| **3** | INT-010 | TBD | 🏠 #HomeInstance (@JRW) | ⬜ RESERVED |
| **3** | INT-011 | TBD | 🏠 #HomeInstance (@IAL) | ⬜ @SHD P3 |
...
|----------|------|---------|-------|--------|
| INT-001 | [AI.WeOwn.Agency](https://ai.weown.agency/) | 🤖 AI for ♾️ WeOwn.Agency 👥 + #MetaAgent (Orchestrator) + ALL MAITs | ♾️ WeOwnNet 🌐 | ✅ ACTIVE |
...
| INT-005 | [AI.YonksTEAM.xyz](https://ai.yonksteam.xyz/) | 🏠 @GTM + @THY #HomeInstance (YonksTEAM) | @GTM | ✅ ACTIVE |
| INT-006 | TBD | 🏠 @SHD #HomeInstance | @SHD | ⬜ RESERVED |
| INT-008 | [AI.RomanDiD.xyz](https://ai.romandid.xyz/) | 🏠 @RMN #HomeInstance | @RMN | 🔄 SETUP |
| INT-009 | AI.CoachLFG.com | 🏠 @LFG #HomeInstance | @LFG | ⬜ @SHD P1 |
| INT-010 | TBD | 🏠 @JRW #HomeInstance | @JRW | ⬜ RESERVED |
| INT-011 | TBD | 🏠 @IAL #HomeInstance | @IAL | ⬜ @SHD P3 |
...
| #WeOwnSeason003 | v3.X.X.X | v3.1.1.2 |
...
| Hotfix (v3.1.1.**2**) | Iteration / hotfix |
...
| L-093 | Instance = Organization boundary; MAITs centralized in INT-001:tools; per-org users access their org instance (e.g., INT-002 = 🔥 BurnedOut.Media 🔀) | GTM_2026-W06_047 |
